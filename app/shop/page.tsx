...
<div className="flex flex-row items-center w-full h-12 bg-[#272727]">
  ...
  <img className="w-48 h-48" src="C:\Users\Mohammad\Desktop\Screenshot 2024-11-05 153837.png" alt="" />
    </div>
...
<svg xmlns="http: www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="#000000" className="size-5 mr-2">
  ...
  <div className="flex flex-col items-center">
    <div className="flex items-center justify-center w-52 h-52 bg-[#272727] mx-10 mt-10 border-solid border-white border-[1px]">
  <img className="w-48 h-48" src="C:\Users\Mohammad\Desktop\Screenshot 2024-11-05 155109.png" alt="" />
    </div>
    <div className="flex flex-row items-center justify-between w-52 h-12 bg-[#fafafa]">
<div className="w-2/3">
...
<svg xmlns="http: www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="#000000" className="size-5 mr-2">
  ...
  <div className="flex flex-col items-center">
    <div className="flex items-center justify-center w-52 h-52 bg-[#272727] mx-10 mt-10 border-solid border-white border-[1px]">
  <img className="w-48 h-48" src="C:\Users\Mohammad\Desktop\Screenshot 2024-11-05 160122.png" alt="" />
    </div>
    <div className="flex flex-row items-center justify-between w-52 h-12 bg-[#fafafa]">
<div className="w-2/3">
...
<svg xmlns="http: www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="#000000" className="size-5 mr-2">
  ...
  <div className="flex flex-col items-center">
    <div className="flex items-center justify-center w-52 h-52 bg-[#272727] mx-10 mt-10 border-solid border-white border-[1px]">
  <img className="w-48 h-48" src="C:\Users\Mohammad\Desktop\shot1.png" alt="" />
    </div>
    <div className="flex flex-row items-center justify-between w-52 h-12 bg-[#fafafa]">
<div className="w-2/3">
...
<svg xmlns="http: www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="#000000" className="size-5 mr-2">
  ...
  <div className="flex flex-col items-center">
    <div className="flex items-center justify-center w-52 h-52 bg-[#272727] mx-10 mt-10 border-solid border-white border-[1px]">
  <img className="w-48 h-48" src="C:\Users\Mohammad\Desktop\Screenshot 2024-11-05 155651.png" alt="" />
    </div>
    <div className="flex flex-row items-center justify-between w-52 h-12 bg-[#fafafa]">
<div className="w-2/3">
...
<svg xmlns="http: www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="#000000" className="size-5 mr-2">
  ...
  <div className="flex flex-col items-center">
    <div className="flex items-center justify-center w-52 h-52 bg-[#272727] mx-10 mt-10 border-solid border-white border-[1px]">
  <img className="w-48 h-48" src="C:\Users\Mohammad\Desktop\Screenshot 2024-11-05 155914.png" alt="" />
    </div>
    <div className="flex flex-row items-center justify-between w-52 h-12 bg-[#fafafa]">
<div className="w-2/3">
...
<svg xmlns="http: www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="#000000" className="size-5 mr-2">
 ...
 <div className="flex flex-col items-center">
   <div className="flex items-center justify-center w-52 h-52 bg-[#272727] mx-10 mt-10 border-solid border-white border-[1px]">
 <img className="w-48 h-48" src="C:\Users\Mohammad\Desktop\Screenshot 2024-11-05 154627.png" alt="" />
   </div>
 <div className="flex flex-row items-center justify-between w-52 h-12 bg-[#fafafa]">
<div className="w-2/3">
